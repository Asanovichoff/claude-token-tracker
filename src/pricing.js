// Per-million-token pricing by model family (USD)
const TIERS = [
...
const FALLBACK = { input: 3, output: 15, cacheWrite: 3.75, cacheRead: 0.30 };
...
export function calcCost(model, inputTokens, outputTokens, cacheCreateTokens, cacheReadTokens) {
